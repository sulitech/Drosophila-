...
if gender=="Female":
    # all
    filename = "figure7_np_npr_(-)np_npr_10_all_t_f_netw.txt"
    # only female
    filename = "figure7_np_npr_(-)np_npr_10_all_t_only_f_netw.txt"


else:
    # all
    filename = "figure7_np_npr_(-)np_npr_10_all_t_m_netw.txt"
    # only male
    filename="figure7_np_npr_(-)np_npr_10_all_t_only_m_netw.txt"
...
def drawGrophAll():
    ...
    if gender == "Female":
        savefile = "figure7_tf_np_npr_network_all_female.pdf"
        plt.savefig(os.path.join(savepath, savefile))
        savefile = "figure7_tf_np_npr_network_all_female.png"
        plt.savefig(os.path.join(savepath, savefile))
    else:
        savefile = "figure7_tf_np_npr_network_all_male.pdf"
        plt.savefig(os.path.join(savepath, savefile))
        savefile = "figure7_tf_np_npr_network_all_male.png"
        plt.savefig(os.path.join(savepath, savefile))
