...
filename="figure7_np_npr_not_exists.txt"
...
def drawGrophAll():
    ...
    plt.title("NP,NPR,TF", fontsize=20)
    ...
    savepath = "D:/project/python/bioinfo/figures/tf/network/except"
    savefile = "figure7_tf_np_npr_network_all_except.pdf"
    plt.savefig(os.path.join(savepath, savefile))


    savepath = "D:/project/python/bioinfo/figures/tf/network/except"
    savefile = "figure7_tf_np_npr_network_all_except.png"
...
def drawGraphTissue(ltname):
    ...
    for j in range(17):
        ...
        savepath = "D:/project/python/bioinfo/figures/tf/network/except"
        savefile = "figure7_tf_npr_network_" + ltname[j] + ".png"
        plt.savefig(os.path.join(savepath, savefile))
